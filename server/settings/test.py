...
ASGI_APPLICATION = 'server.settings.testAsgi.application'
WSGI_APPLICATION = 'server.settings.testWsgi.application'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'server.utils.drf_custom_tools.custom_exception_handler',
}
